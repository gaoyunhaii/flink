...
public class CheckpointCoordinatorFailureTest extends TestLogger {
	...
	public void testFailingCompletedCheckpointStoreAdd() throws Exception {
		...
		ExecutionGraph testGraph = CheckpointCoordinatorTestingUtils.createAllRunningTestGraph(jobVertexId);
		...
		AcknowledgeCheckpoint acknowledgeMessage = new AcknowledgeCheckpoint(
			testGraph.getJobID(),
