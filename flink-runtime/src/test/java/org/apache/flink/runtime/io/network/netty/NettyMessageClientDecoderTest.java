 ...
 */
public class NettyMessageClientDecoderTest {
    ...
    public void testDownstreamMessageDecode() throws Exception {
        ...
        EmbeddedChannel channel = new EmbeddedChannel(
                new NettyMessageClientDecoder(createPartitionRequestClientHandler(8)));
    ...
    public void testDownstreamMessageDecodeWithReleasedInputChannel() throws Exception {
        ...
        EmbeddedChannel channel = new EmbeddedChannel(
                new NettyMessageClientDecoder(createPartitionRequestClientHandler(6)));
        ...
        readInputAndVerify(channel, splitBuffers, expectedMessages);
        ...
        for (int i = 0; i < expected.length; ++i) {
            ...
            if (expected[i] instanceof NettyMessage.AddCredit ||
                ...
                if (((NettyMessage.BufferResponse) expected[i]).receiverId.equals(RELEASED_INPUT_CHANNEL_ID)) {
					...
					assertEquals(0, ((NettyMessage.BufferResponse) decodedMessages.get(i)).getBuffer().getSize());
                } else {
