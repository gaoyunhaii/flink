...
class NetworkBufferAllocator {
	...
	NetworkBufferAllocator(NetworkClientHandler partitionRequestClientHandler) {
		this.partitionRequestClientHandler = checkNotNull(partitionRequestClientHandler);
		this.placeHolderBuffer = allocateUnPooledNetworkBuffer(0);
	}
	...
	/**
	 * Gets the placeholder buffer of this allocator.
	 *
