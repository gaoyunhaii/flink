...
public interface SchedulerNG {
	...
	CompletableFuture<Acknowledge> reportFinalSnapshot(JobID jobID, ExecutionAttemptID executionAttemptID, CheckpointMetrics checkpointMetrics, TaskStateSnapshot checkpointState);
