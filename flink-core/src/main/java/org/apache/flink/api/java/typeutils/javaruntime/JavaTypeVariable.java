...
public class JavaTypeVariable implements AbstractTypeVariable, JavaTypeProvider {
	...
	@Override
	public AbstractTypeClass getGenericDeclaration() {
		return (AbstractTypeClass) JavaTypeConversion.convertToAbstractType(
