 ...
 */
@Public
public final class TupleTypeInfo<T extends Tuple> extends TupleTypeInfoBase<T> implements GenericClassAware<T> {
	...
	public Class<T> getGenericClass() {
		return (Class<T>) GENERIC_CLASSES.get(types.length);
	}
