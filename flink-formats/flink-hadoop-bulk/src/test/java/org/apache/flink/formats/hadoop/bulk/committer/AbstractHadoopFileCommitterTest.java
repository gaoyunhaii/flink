...
public abstract class AbstractHadoopFileCommitterTest extends AbstractTestBase {
	...
	private DefaultHadoopFileCommitterFactory committerFactory;
	...
	public void setup() throws IOException {
		...
		committerFactory = new DefaultHadoopFileCommitterFactory();
	}

	@After
	public void teardown() throws IOException {
		cleanup(configuration, basePath, version);
	}
	...
	protected abstract int getVersion() throws IOException;
	...
	public void testCommitOneFile() throws IOException {
		...
		HadoopFileCommitter committer = committerFactory.create(version, configuration, targetFilePath);
	...
	public void testCommitReWrittenFileAfterFailOver() throws IOException {
		...
		committer = committerFactory.create(version, configuration, targetFilePath);
		writeFile(committer.getInProgressFilePath(), configuration);
	...
	public void testCommitMultipleFilesOneByOne() throws IOException {
		...
		HadoopFileCommitter committer1 = committerFactory.create(version, configuration, targetFilePath1);
		HadoopFileCommitter committer2 = committerFactory.create(version, configuration, targetFilePath2);
