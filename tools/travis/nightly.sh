...
MVN_COMMON_OPTIONS="-nsu -B -Dflink.forkCount=2 -Dflink.forkCountTestPackage=2 -Dmaven.wagon.http.pool=false -Dfast -Pskip-webui-build -Dcheckstyle.skip=true -Denforcer.skip=true -pl !flink-runtime-web"
